...
cosmo2 = FlatLambdaCDM(H0=65, Om0=0.3, Ob0=0.)
    

def generate_lens(sigma_bkg = sigma_bkg, exp_time = exp_time,
    ...
    lens_model_class2 = LensModel(lens_model_list=lens_model_list, z_lens=z_lens, z_source=z_source, cosmo=cosmo2)
